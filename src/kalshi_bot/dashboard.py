...
_DEFAULT_DB = str(Path(_VOLUME) / "coby_bnb_dashboard.db") if _VOLUME else "/tmp/coby_bnb_dashboard.db"
...
def _init_db() -> None:
    ...
    with _db_lock, _db() as conn:
        ...
        conn.execute(
            ...
            seconds_left REAL, bnb_price REAL, target_price REAL,
...
def record_model_snapshot(**x: Any) -> None:
    ...
    keys = [
        "ticker", "seconds_left", "bnb_price", "target_price", "separation",
