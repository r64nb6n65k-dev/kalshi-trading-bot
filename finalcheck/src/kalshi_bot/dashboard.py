...
_DEFAULT_DB = str(Path(_VOLUME) / "coby_dashboard.db") if _VOLUME else "/tmp/coby_dashboard.db"
...
def _init_db() -> None:
    ...
    with _db_lock, _db() as conn:
        ...
        conn.execute(
            ...
            seconds_left REAL, btc_price REAL, target_price REAL,
